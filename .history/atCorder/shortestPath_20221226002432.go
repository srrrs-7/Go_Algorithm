...
func top(sx, sy, gx, gy int, grid [][]string) (int, bool) {
	var count = 0
	if sx-1 < 0 {
		return count, false
...
func right(sx, sy, gx, gy int, grid [][]string) (int, bool) {
	var count = 0
	if sx-1 < 0 {
		return count, false
	} else if grid[sx-1][sy] == "1" {
	...
	return right(sx-1, sy, gx, gy, grid)
}

func bottom(sx, sy, gx, gy int, grid [][]string) (int, bool) {
	var count = 0
	if sx-1 < 0 {
		return count, false
	} else if grid[sx-1][sy] == "1" {
...
func left(sx, sy, gx, gy int, grid [][]string) (int, bool) {
	var count = 0
	if sy-1 < 0 {
		return count, false
